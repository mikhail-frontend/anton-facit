...
const LessonContent = () => {
    ...
    const video = useMemo(() => {
        const parseVideoString = (video: string) => {
            ...
            return Array.isArray(parsedVideo) ? parsedVideo.length ? parsedVideo[0] : {} : parsedVideo;
        };
    ...
    const videoSources = useMemo(() => {
        if (!video?.custom_properties || !Object.keys(video?.custom_properties)?.length) return null;
    ...
    return (
        <>
            ...
            <div className='row g-4'>
                ...
                {video && <VideoWrap videoSources={videoSources}
